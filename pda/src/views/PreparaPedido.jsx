...
import { usePreparacionPedido, FASE } from '../hooks/usePreparacionPedido';
      ...
      <div className="mt-1 flex items-center justify-between bg-gray-50 rounded-md p-2 border border-gray-200 pl-3 ml-1 mr-1">
        <div className="flex gap-3">
          <div className="flex flex-col">
            ...
            <span className="text-lg font-black text-gray-400 leading-none">{lineaActual.cantsolicitada}</span>
          </div>
          <div className="flex flex-col">
            <span className="text-[10px] text-gray-500 font-bold uppercase tracking-wider">PREPARADO</span>
            <span className="text-lg font-black text-gray-400 leading-none">{pr}</span>
          </div>
          <div className="flex flex-col pl-2 border-l border-gray-300">
            <span className="text-[10px] text-sga-primary font-bold uppercase tracking-wider">PDTE</span>
